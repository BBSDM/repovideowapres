...
if($_POST['ganti1'])
{
    ...
    "id" =>$id,
         ...
         "waktu"=> $waktu,
          ...
          "latitude"=>"0",
          "language"=>"en");
          $DATA->updateData($data_form,"contact");
          $UTILITY->location_goto("content/contact/edit/$id");
          exit;
}
...
if($image_file!="")
{
     ...
     $filesave="contact"."_$waktu"."_$image_file";
...
if ($kondisi == "tambah") {
          ...
          $DATA->insertData($data_form,"contact");
         $UTILITY->location_goto("content/contact");
...
if ($hapusdata!= "") {
     ...
     $DATA->deleteData($hapusdata,"contact");
     $UTILITY->location_goto("content/contact");
}
if ($publishdata!= "") {
  if($publishvalue=="Pending")
       $DATA->publishData($publishdata,"contact",1);
  else
        $DATA->publishData($publishdata,"contact",0);
     $UTILITY->location_goto("content/contact");
}
?>
