...
if($_POST['ganti1'])
{
    ...
    "id" =>$id,
         ...
         "waktu"=> $waktu,
          ...
          "status_display"=>0,
          "language"=>"en");
          $DATA->updateData($data_form,"partnership");
        
          $UTILITY->location_goto("content/partnership/edit/$id");
          exit;
}
...
if($image_file!="")
{
     ...
     $filesave="partnership"."_$waktu"."_$image_file";
...
if ($kondisi == "tambah") {
          ...
          $DATA->insertData($data_form,"partnership");
         $UTILITY->location_goto("content/partnership/$kategori");
...
if ($hapusdata!= "") {
     ...
     $DATA->deleteData($hapusdata,"partnership");
     $UTILITY->location_goto("content/partnership/$kategori");
}
if ($publishdata!= "") {
  if($publishvalue=="Pending")
       $DATA->publishData($publishdata,"partnership",1);
  else
        $DATA->publishData($publishdata,"partnership",0);
 // echo "content/partnership/$publishkategori";
    $UTILITY->location_goto("content/partnership/$kategori");
}
?>
