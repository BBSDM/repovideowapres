...
if($_POST['ganti1'])
{
    ...
    "id" =>$id,
         ...
         "waktu"=> $waktu,
          ...
          "status_display"=>0,
          "language"=>"en");
          $DATA->updateData($data_form,"tenant");
        
          $UTILITY->location_goto("content/tenant/edit/$id");
          exit;
}
...
if($image_file!="")
{
     ...
     $filesave="tenant"."_$waktu"."_$image_file";
...
if ($kondisi == "tambah") {
          ...
          $DATA->insertData($data_form,"tenant");
         $UTILITY->location_goto("content/tenant/$kategori");
...
if ($hapusdata!= "") {
     ...
     $DATA->deleteData($hapusdata,"tenant");
     $UTILITY->location_goto("content/tenant/$kategori");
}
if ($publishdata!= "") {
  if($publishvalue=="Pending")
       $DATA->publishData($publishdata,"tenant",1);
  else
        $DATA->publishData($publishdata,"tenant",0);
 // echo "content/tenant/$publishkategori";
    $UTILITY->location_goto("content/tenant/$kategori");
}
?>
