...
if($_POST['ganti1'])
{
    ...
    "id" =>$id,
         ...
         "waktu"=> $waktu,
          ...
          "status_display"=>0,
          "language"=>"en");
          $DATA->updateData($data_form,"collaboration");
        
          $UTILITY->location_goto("content/collaboration/edit/$id");
          exit;
}
...
if($image_file!="")
{
     ...
     $filesave="collaboration"."_$waktu"."_$image_file";
...
if ($kondisi == "tambah") {
          ...
          $DATA->insertData($data_form,"collaboration");
         $UTILITY->location_goto("content/collaboration/$kategori");
...
if ($hapusdata!= "") {
     ...
     $DATA->deleteData($hapusdata,"collaboration");
     $UTILITY->location_goto("content/collaboration/$kategori");
}
if ($publishdata!= "") {
  if($publishvalue=="Pending")
       $DATA->publishData($publishdata,"collaboration",1);
  else
        $DATA->publishData($publishdata,"collaboration",0);
 // echo "content/collaboration/$publishkategori";
    $UTILITY->location_goto("content/collaboration/$kategori");
}
?>
