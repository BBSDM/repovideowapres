					    ...
					    <form>
							...
							<h4>Syarat Dan Ketentuan</h4>			
								<ol> 
									...
									<li>Jika Anda merasa keberatan dengan syarat dan ketentuan yang kami ajukan, maka kami anjurkan untuk tidak menggunakan layanan <a href="<?=$url_rewrite?>http://foto.wapresri.go.id">foto.wapresri.go.id</a>.</li> 
								</ol>								
