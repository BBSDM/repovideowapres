<title><?=$TITLE?></title>
			...
			<link href="<?=$url_rewrite?>bootstrap/css/bootstrap.min.css" rel="stylesheet"/>
			<link href="<?=$url_rewrite?>css/style.css" rel="stylesheet" type="text/css"  media="all" />
			...
			<script type="text/javascript" src="<?=$url_rewrite?>js/jquery-1.9.1.min.js"></script>
