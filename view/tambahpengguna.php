...
<div class="content">			
	...
	<div id="mainpage">
		<div id="container">
			...
			<ul>
			<li><a href="<?=$url_rewrite?>content/daftarpengguna"><span>Daftar Pengguna </span></a></li>
			<li><a href="<?=$url_rewrite?>content/tambahpengguna" class="current"><span>Tambah Pengguna</span></a></li>
			</ul>
			</div>
