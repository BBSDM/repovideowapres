...
<div class="content">			
	...
	<div id="mainpage">
		<div id="container">
			...
			<ul>
			<li><a href="<?=$url_rewrite?>content/daftar_aplikasi"><span>Daftar Aplikasi Client</span></a></li>
			<li><a href="<?=$url_rewrite?>content/tambah_aplikasi" class="current"><span>Tambah Aplikasi Client</span></a></li>
			</ul>
			</div>
		...
		?>
			<div id="container2">
				...
				<div class="home">  
				<p>
				<form enctype="multipart/form-data" name="berita" method="post" action="<?=$alamat_web?>/view/tambah_aplikasi">
