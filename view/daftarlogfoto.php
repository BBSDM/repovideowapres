...
<div id="mainpage">
		<div id="container">
			...
			<ul>
			<li><a href="<?=$url_rewrite?>content/daftarlogfoto" class="current"><span>Daftar Log Video</span></a></li>
			<li><a href="<?=$url_rewrite?>content/daftarloglogin"><span>Daftar Log Login</span></a></li>
			</ul>
			</div>
        ...
        $('#example').dataTable(
                {
                    ...
                    "sAjaxSource": "<?=$url_rewrite?>api/api_log_video.php"
               }
