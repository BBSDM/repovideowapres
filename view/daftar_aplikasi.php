...
<div class="content">			
	...
	<div id="mainpage">
		<div id="container">
			...
			<ul>
			<li><a href="<?=$url_rewrite?>content/daftar_aplikasi" class="current"><span>Daftar Aplikasi Client</span></a></li>
			<li><a href="<?=$url_rewrite?>content/tambah_aplikasi"><span>Tambah Aplikasi Client</span></a></li>
			</ul>
			</div>
