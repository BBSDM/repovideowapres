...
<html>
	...
	<table style="border:1px solid rgb(215,212,199); margin-bottom:40px; font-family: Arial, Helvetica, sans-serif;font-size:13px;">
		<h3>Panduan Pendaftaran<h3> </div>
		<tr>
	
		<td><img src="images/panduan.png" width="730px" height="200px"></td>
		<td><ol><li><p><strong>Silahkan mendaftar di formulir pendaftaran di bawah ini</strong></p></li>
			<li><p><strong>Link konfirmasi akan dikirimkan melalui email</strong></p></li>
			<li><p><strong>Klik link dalam email untuk mengaktifkan akun</strong></p></li>
			<li><p><strong>Proses pendaftaran selesai. Silahkan kembali ke halaman login untuk masuk</strong></p></li>
...
<form enctype="multipart/form-data" id="pendaftaranForm" name="pendaftaranForm" method="post"  onsubmit="return processForm(this);">	
<div id="success_message" style="display: none; margin-bottom:20px; text-align:center;">Proses pendaftaran berhasil<br />Silahkan konfirmasi username melalui email Anda</div>	
<div id="loading" align="center" style="margin-bottom:20px;"></div>
<table style="border:1px solid rgb(215,212,199); padding:10px;margin-bottom:30px; cellpadding="0" cellspacing="0" border="0">
<!------end of panduan pendaftaran----->

				  	<h3>Formulir Pendaftaran</h3>
					    <form<?php echo "$url_rewrite"."proses/pendaftaran";?>>
					    	<div>
						    ...
						    <div>
								...
								<?php	
								  ...
								  $options = array();
								  $options['securimage_path'] ='secureimage';
							...
							<div style=" padding:4px;overflow:auto;width:980px;line-height:20px;height:200px;border: 1px solid rgb(215,212,199);font-size: 14px; margin-bottom:15px;">  
							<h3>Syarat Dan Ketentuan</h3> 		
								<ol> 
									<li><p>Syarat dan ketentuan dalam penggunaan foto pada layanan situs ini adalah mengikat dan harus disepakati.</p> </li> 
